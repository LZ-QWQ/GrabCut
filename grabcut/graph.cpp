	  ...
	  error_function(err_function)
{
	...
	char temp[] = "Not enough memory!";//无奈之举
	if (!nodes || !arcs) { if (error_function) (*error_function)(temp); exit(1); }
	...
	void Graph<captype,tcaptype,flowtype>::reallocate_nodes(int num)
{
	...
	char temp[] = "Not enough memory!";//无奈之举
	if (!nodes) { if (error_function) (*error_function)(temp); exit(1); }
	...
	void Graph<captype,tcaptype,flowtype>::reallocate_arcs()
{
	...
	char temp[] = "Not enough memory!";//无奈之举
	if (!arcs) { if (error_function) (*error_function)(temp); exit(1); }
